...
const CACHE_VERSION = 'gi-v8.104.7';
...
const STATIC_PRECACHE = [
  '/assets/dashboard.css?v=8.23.8',
  '/assets/dashboard.js?v=8.99.4',
  ...
  '/assets/heatmap-modal.js?v=2.3.3',
  ...
  '/assets/calendar-panel.js?v=1.12.0',
