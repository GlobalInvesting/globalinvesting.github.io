...
const CACHE_VERSION = 'gi-v8.139.1';
...
const STATIC_PRECACHE = [
  '/assets/dashboard.css?v=8.23.15',
  '/assets/dashboard.js?v=8.101.0',
  '/assets/gi-auth.js?v=1.7.2',
  '/assets/gi-overview.js?v=1.3.0',
  ...
  '/assets/heatmap-modal.js?v=2.6.2',
