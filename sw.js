...
const CACHE_VERSION = 'gi-v8.161.4';
...
const STATIC_PRECACHE = [
  '/assets/dashboard.css?v=8.23.17',
  '/assets/dashboard.js?v=8.101.7',
  '/assets/gi-auth.js?v=1.7.2',
  '/assets/gi-overview.js?v=1.4.1',
  '/assets/fx-websocket.js?v=1.0.0',
  '/assets/cot-modal-chart.js?v=7.91.4',
