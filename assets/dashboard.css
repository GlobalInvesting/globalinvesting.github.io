*, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .sig-notif-toggle.sig-notif-on:hover { background: rgba(41,98,255,.14); }
  ...
  .narr-text  { font-size: 12px; color: var(--text); line-height: 1.5; flex: 1; font-family: var(--font-ui); word-wrap: break-word; overflow-wrap: break-word; white-space: normal; min-width: 0; }
  .narr-regime {
  ...
  td.sym { font-weight: 700; font-size: 12px; color: #fff; font-family: var(--font-ui); }
  ...
  .ca-cell  { background: var(--bg); padding: 7px 8px; cursor: pointer; transition: background .1s; border-bottom: 1px solid var(--border); }
  ...
  .alert-row {
    ...
    border-bottom: 1px solid var(--border);
    align-items: flex-start; cursor: pointer; transition: background .1s;
  }
  .alert-row:hover { background: var(--bg3); }
  .alert-row:last-child { border-bottom: none; }
  .a-time { color: var(--text3); font-size: 10px; white-space: nowrap; margin-top: 1px; min-width: 34px; font-family: var(--font-mono); }
  ...
  .a-text { color: var(--text); flex: 1; font-size: 11px; line-height: 1.45; font-family: var(--font-ui); }
  .a-text strong { color: #fff; font-weight: 700; }
  /* Evidence chips — data traceability for AI signals. Hidden by default, toggled on row click. */
  .a-evidence {
    display: none; flex-wrap: wrap; gap: 4px;
    margin-top: 5px; padding-top: 5px;
    border-top: 1px solid var(--border2);
  }
  .a-evidence.a-evidence-open { display: flex; }
  .a-ev-chip {
  ...
  /* Subtle indicator that the row is clickable when evidence is available */
  .a-has-ev:hover .a-text { color: var(--text); }
  .a-has-ev::after {
    content: '▸'; font-size: 8px; color: var(--text3);
    align-self: center; margin-left: auto; flex-shrink: 0;
    transition: transform .15s;
  }
  .a-has-ev .a-evidence-open ~ .a-has-ev::after,
  .a-has-ev:has(.a-evidence-open)::after { transform: rotate(90deg); }
  ...
  /* ── CARRY TRADE RANKING ─────────────────────────────────────── */
  .carry-rank-row { display:grid; grid-template-columns:12px 52px 28px 1fr 40px; align-items:center; gap:3px; padding:4px 8px; border-bottom:1px solid var(--border); font-family:var(--font-ui); font-size:11px; cursor:pointer; transition:background .1s; }
  ...
  .cr-pair { font-weight:700; color:var(--text); white-space:nowrap; letter-spacing:.01em; }
  .cr-regimes { display:flex; align-items:center; gap:0; font-size:9px; white-space:nowrap; }
  .cr-regime { font-size:9px; font-weight:700; line-height:1; }
  .cr-hike  { color:var(--up); }
  .cr-cut   { color:var(--down); }
  .cr-hold  { color:var(--text3); }
  .cr-regime-sep { color:var(--text3); font-size:8px; margin:0 1px; }
  .cr-bar-wrap { height:4px; background:var(--bg3); border-radius:2px; overflow:hidden; }
  .cr-bar { height:100%; background:var(--up); border-radius:2px; opacity:.7; max-width:100%; }
  .cr-diff { font-family:var(--font-mono); font-size:10px; text-align:right; white-space:nowrap; }
  ...
  @media (max-width: 900px) {
    ...
    /* COT panel: horizontal scroll so all 8 columns stay readable */
    #cot-rows { overflow-x: auto; -webkit-overflow-scrolling: touch; }
    .cot-row {
      grid-template-columns: 32px 80px 36px 54px 46px 12px 42px 58px;
      gap: 4px;
      min-width: 380px;
    }
    .cot-sym { font-size: 10px; }
  ...
  #gdpr-banner {
    ...
    background: #1a1f2e; border-top: 2px solid #2962ff;
  ...
  #gdpr-accept { background: #2962ff; color: #fff; }
