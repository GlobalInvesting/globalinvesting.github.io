    ...
    <div class="pd-inline">
      ...
      <div class="pd-inline-group">
        ...
        <div class="pd-inline-metrics">
          ...
          <div class="pd-inline-metric fx-tip" data-tip-title="ATM Implied Volatility" data-tip-body="ATM IV from an institutional-grade source: CBOE/CME FX Volatility Indexes (^EUVIX/^BPVIX/^JYVIX) for EUR/GBP/JPY — same variance-swap methodology as VIX; PHLX World Currency Options index (^XDA/^XDZ) for AUD/NZD; CME futures options / ETF fallback for CHF/CAD. ${atmIvRank != null ? 'Color = IV Rank vs 52-week range: green rank&lt;30 (historically cheap), red rank&gt;70 (historically expensive).' : 'Color = cost of hedging: green ≤7% (cheap), red >12% (expensive) — fixed band; IV Rank not yet available (needs ≥4 weeks history).'} Not a directional signal.">
