...
.cm-psig { display:flex;flex-direction:column;gap:3px;margin:0;padding:8px 14px;background:var(--bg);border-top:1px solid var(--border,#252d3d);border-left:3px solid var(--border,#252d3d); }
.cm-psig-hd { display:flex;align-items:center;justify-content:space-between; }
.cm-psig-tag { font-size:8.5px;font-weight:600;letter-spacing:.06em;text-transform:uppercase;color:var(--text2);font-family:var(--font-mono); }
.cm-psig-meta { font-size:8px;color:var(--text2);font-family:var(--font-mono); }
.cm-psig-dir { font-size:10.5px;font-weight:600;color:var(--text);font-family:var(--font-mono); }
.cm-psig-note { font-size:9.5px;color:var(--text2);line-height:1.5;font-family:var(--font-mono); }
