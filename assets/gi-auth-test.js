/**
 * ⚠ TEST COPY — assets/gi-auth-test.js — mirrors assets/gi-auth.js v1.5.0
 * Loaded only by index-test.html, for previewing the v1.5.0 gate-removal
 * change (see CHANGELOG.md v8.128.0) before it goes live in production.
 * Not linked from index.html or any production page. Same WORKER_URL as
 * production — this tests UI/gating behavior only, not a separate backend.
 * Delete this file (and index-test.html) once v1.5.0 ships to index.html.
 *
